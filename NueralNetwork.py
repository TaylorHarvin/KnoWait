...
class NueralNetwork:
    ...
    # Calculate the output of the nueral network given the normalized input set
...
nn2 = NueralNetwork(4,3,2,nn.inToHidWeights,nn.hidToOutWeights)
